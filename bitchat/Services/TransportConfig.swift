...
enum TransportConfig {
    ...
    static let agentQuoteCollectionWindowSeconds: TimeInterval = 1.8
    static let agentQuoteLockSeconds: TimeInterval = 120
    static let agentQuoteMaxCandidateProviders: Int = 4
    static let agentQuoteDefaultMaxOptionsPerProvider: UInt8 = 3
    static let agentQuoteDefaultImmediateDiscountBps: UInt16 = 0
    static let agentQuoteDefaultStandardWaitSeconds: UInt16 = 15
    static let agentQuoteDefaultStandardDiscountBps: UInt16 = 1500
    static let agentQuoteDefaultEconomyWaitSeconds: UInt16 = 60
    static let agentQuoteDefaultEconomyDiscountBps: UInt16 = 3000
    static let agentQuoteMaxTotalOptions: Int = 12
    static let agentQuoteMaxPendingSelections: Int = 8
    static let agentQuoteProviderCacheMaxEntries: Int = 256
    ...
    static let agentMemoryRecallMaxSnippets: Int = 2
    static let agentMemorySnippetMaxBytes: Int = 1_000
    static let agentMemoryContextMaxBytes: Int = 2_400
    static let settlementGossipMaxMessageBytes: Int = 2_048
    static let settlementGossipMaxNullifiersPerMessage: Int = 64
    static let settlementGossipObservationCapacity: Int = 8_192
    static let settlementGossipObservationTTLSeconds: TimeInterval = 12 * 60 * 60
    static let settlementGossipSeenEventCapacity: Int = 4_096
    static let settlementGossipConflictCooldownSeconds: TimeInterval = 30
    static let settlementGossipSenderWindowSeconds: TimeInterval = 30
    static let settlementGossipSenderWindowMaxMessages: Int = 96
    static let settlementGossipSenderTrackerCapacity: Int = 256
    static let settlementGossipGlobalLookbackSeconds: TimeInterval = 60 * 60
    static let notaryGossipMaxMessageBytes: Int = 2_048
    static let notaryGossipSeenEventCapacity: Int = 4_096
    static let notaryReceiptCacheCapacity: Int = 512
    static let notaryReceiptTTLSeconds: TimeInterval = 10 * 60
    static let notaryReceiptCollectTimeoutMs: UInt64 = 1_500
    static let notaryReceiptCollectPollIntervalMs: UInt64 = 120
    static let notaryRequiredSignatureMax: Int = 8
    static let mintProxyRequestTimeoutSeconds: TimeInterval = 8
    static let mintProxyMaxCandidateAttempts: Int = 3
    static let mintGatewayHTTPTimeoutSeconds: TimeInterval = 15
    static let mintGatewayMaxBodyBytes: Int = 128 * 1024
    static let mintGatewayResponseCacheCapacity: Int = 512
    static let mintGatewayResponseCacheTTLSeconds: TimeInterval = 15 * 60
